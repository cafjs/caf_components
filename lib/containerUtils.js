...
exports.utils = function(that, maxRetries, retryDelay) {
     ...
     * info.
     *
     *  @return {function(string, caf.cb)} A function of type
     * `function(string, caf.cb)` that will check
     ...
     *  otherwise no retry.
     *
     *  @return {function(caf.specType, caf.cb)} A function of type
     * `function(caf.specType, caf.cb)` that will check and restart a child
     *  component.
     *
     * @memberof! module:caf_components/containerUtils#
     ...
     *
     *  @return {function(string, caf.cb)} A function of type
     * `function(string, caf.cb)` to shutdown a child component.
     *
     * @memberof! module:caf_components/containerUtils#
     * @alias shutdownChild
     */
     ...
     *
     *  @return {function(caf.specType, caf.cb)} A function of type
     * `function(caf.specType, caf.cb)` that will create
     ...
     * no retry.
     *
     * @return {function(caf.cb)} A function of type `function(caf.cb)` that
     ...
     * also be shutdown.
     *
     * @param {function(data, cb)} f A function of type `function(data, cb)`
     * that should respect a shutdown invariant.
     * @param {Object=}  data Optional meta-data.
     * @param {caf.cb} cb A callback for `f`  or the shutdown call.
     *
     * @memberof! module:caf_components/containerUtils#
