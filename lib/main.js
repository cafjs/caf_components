 ...
 * @param {Array.<Object> | null} modules A sequence of modules  to load
 *  descriptions and implementations (see 'gen_loader'). Use 'null' to avoid
 *  modifying current loader configuration.
 * @param {caf.cb} cb A callback to return `$` with the created top level
 *  component bound by its name or an error.
 *
 */
exports.load = function($, spec, resourceName, modules, cb) {
    try {
        /*
         *
