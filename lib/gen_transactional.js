...
exports.constructor = function($, spec) {
    ...
    var applyFun = function(method, args) {
        return function(x, cb0) {
            try {
                ...
                var wrappedMethod = myUtils.wrapAsyncFunction(x.obj[method],
                                                              x.obj);
    ...
    var replayLog = function(cb) {
        async.eachSeries(logActions, function(x, cb0) {
            try {
                ...
                args.push(cb0);
                var wrappedMethod = myUtils
                        .wrapAsyncFunction(logActionsTarget[x.method],
                                           logActionsTarget);
    ...
    that.__ca_resume__ = function(cp, cb) {
        try {
            ...
            childrenSeriesTransF(function(x, cb1) {
                try {
                    var wrappedMethod = myUtils
                            .wrapAsyncFunction(x.obj.__ca_resume__, x.obj);
     ...
     * {@link module:caf_components/gen_transactional#__ca_resume__} for
