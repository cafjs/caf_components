 ...
 * helper, i.e., a method named `constructor()`.
 *
 ...
 *  Types:
 *
 *  `caf.specType : {name: string, module: string,
 *                    description=: string, env: Object,
 *                    components=: Array.<caf.specType>}`
 *
 *  `caf.ctxType: Object.<string, Object>`
 *
 * @param {caf.ctxType} $ A context containing references to other components.
 * @param {caf.specType} spec Configuration data for this component.
...
exports.constructor = function($, spec) {
     ...
     *  @param {caf.cb} cb A callback invoked after the check,
     ...
     *  @param {caf.cb} cb A callback invoked after
